create table account(id bigserial primary key,
...
create table users(id bigserial primary key,
 ...
 create table user_status(id bigserial primary key,
							  date timestamp not null,
							  state bool default false not null);
create table chat_user(id bigserial primary key,
		 ...
		 create table session(id bigserial primary key,
         					 added_date timestamp not null,
         					session_id text not null,
         					user_id bigint references users(id) not null);

 create table chat(id bigserial primary key,
...
create table message_state (id bigserial primary key,
